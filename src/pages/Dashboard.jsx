...
const Dashboard = () => {
  ...
  return (
    <div className="space-y-6" data-testid="app-loaded">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <StatCard
          title="Total SKUs"
          value={dashboardData?.totalSKUs || "Loading..."}
      ...
      {dashboardData?.schemaValidation && (
        <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-4">
          <div className="flex items-center space-x-2">
            <CheckCircle className="w-5 h-5 text-green-500" />
            <span className="text-green-500 font-medium">Schema Validation: {dashboardData.schemaValidation.message}</span>
          </div>
        </div>
      )}
