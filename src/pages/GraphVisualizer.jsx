...
const GraphVisualizer = () => {
  ...
  return (
    <div className="relative h-full bg-gray-900">
      {/* Minimal Header Bar */}
      <div className="absolute top-0 left-0 right-0 z-50 bg-black/80 backdrop-blur-sm border-b border-white/10 px-4 py-2">
      ...
      {/* Minimal Sidebar */}
      <div className={`absolute top-12 right-0 z-40 transition-all duration-300 ${
        sidebarCollapsed ? 'translate-x-full' : 'translate-x-0'
      }`}>
        <div className="bg-black/90 backdrop-blur-sm border-l border-white/10 p-4 w-64 max-h-[calc(100vh-60px)] overflow-y-auto">
          {/* Filters Header */}
